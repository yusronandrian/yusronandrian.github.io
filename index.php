...
<html lang="en" class="no-js">
  <head>
    ...
    <title>Yusron Andrian</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
    <meta name="description" content="Yusron Andrian" />
    <meta name="keywords" content="vcard, responsive, retina, resume, jquery, css3, bootstrap, Material CV, portfolio, yusron, andrian" />
    ...
    <div id="page" class="page">
      ...
      <header id="site_header" class="header mobile-menu-hide">
        <div class="header-content">
          <div class="site-title-block mobile-hidden">
            <div class="site-title">Yusron <span>Andrian</span></div>
          </div>
      ...
      <div class="mobile-header mobile-visible">
        <div class="mobile-logo-container">
          <div class="mobile-site-title">Yusron Andrian</div>
        </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-8 col-md-8 col-lg-8">
                      <div class="title-block">
                        <h1>Yusron Andrian</h1>
                        <div class="owl-carousel text-rotation">                                    
                          <div class="item">
                            <div class="sp-subtitle">Developer - Traveller - Eater</div>
                          </div>
                          <!-- <div class="item">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6">
                      <div class="about-me">
                        ...
                        <p>
                          Hello! I’m Yusron Andrian. Who has passionate in Tech Updates and also Travelling. Like Spicy Food.
                        </p>
                      </div>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6">
                      <ul class="info-list">
                        ...
                        <li><span class="title">Address</span><span class="value">Surabaya, Indonesia</span></li>
                        <li><span class="title">e-mail</span><span class="value"><a href="mailto:yusronandrian@gmail.com">yusronandrian@gmail.com</a></span></li>
                        <li><span class="title">Linked in</span><span class="value"><a href="https://id.linkedin.com/in/yusron-andrian-01b33a12b">Yusron Andrian</a></span></li>
                        <li><span class="title">Phone</span><span class="value">+6281 239 798 540</span></li>
                      ...
                      <div class="block">
                        ...
                        <div class="timeline">
                          ...
                          <div class="timeline-item">
                            <h4 class="item-title">Bachelor Degree</h4>
                            <span class="item-period">2018</span>
                            <span class="item-small">Universitas Surabaya</span>
                            <p class="item-description">Information Technology, 3.544</p>
                          </div>
                          <!-- / Education 1 -->
                          ...
                          <div class="timeline-item">
                            ...
                            <span class="item-small">SMAN 1 KUPANG</span>
                            <p class="item-description">Acceleration</p>
                          </div>
                          <!-- / Education 2 -->
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6">
                      <div class="block">
                        ...
                        <div class="timeline">
                          <!-- Experience 1 -->
                          <div class="timeline-item">
                            <h4 class="item-title">Information Technology Staff</h4>
                            <span class="item-period">Mar 2018 - Current</span>
                            <span class="item-small">Real Estate</span>
                            <p class="item-description">Maintain ERP, Developing Software, Design and Implement Robot</p>
                          </div>
                          <!-- / Experience 1 -->
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6">
                      <div class="block">
                        ...
                        <div class="skills-info">
                          <h4>Web Development (Laravel, Code Igniter)</h4>                               
                          <div class="skill-container">
                            <div class="skill-percentage skill-4"></div>
                          </div>
                          <h4>Desktop Development ( C#, Java, VB ) </h4>
                          <div class="skill-container">
                            <div class="skill-percentage skill-6"></div>
                          </div> 

                          <h4>Mobile Development ( Java, Phonegap, React Native, Ionic )</h4>
                          <div class="skill-container">
...
<!-- 
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6">
                      <div class="block">
                        ...
                        <div class="skills-info">
                          <h4>Servers (Windows Server, Centos)</h4>                               
                          <div class="skill-container">
    ...
    <footer>
      <div class="copyrights">© 2020 All rights reserved. Made by Yusron Andrian</div>
    </footer>
